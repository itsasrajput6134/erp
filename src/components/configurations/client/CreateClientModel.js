...
const CreateClientModel = ({ isOpen, onClose, addClients, handleChangeAdd, handleAdd }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <input
                ...
                value={addClients.bussinessnumber}
                onChange={handleChangeAdd}
