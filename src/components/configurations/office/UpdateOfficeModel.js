...
const UpdateOfficeModel = ({ isOpen, isClose, updateOffice, handleChangeUpdate, handlUpdateSubmit }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                id="officeLocation"
                name="officeLocation"
                value={updateOffice.officeLocation}
                onChange={handleChangeUpdate}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                id="officeAddress"
                name="officeAddress"
                value={updateOffice.officeAddress}
                onChange={handleChangeUpdate}
            ...
            <div>
              ...
              <input
                ...
                id="officePincode"
                name="officePincode"
                value={updateOffice.officePincode}
                onChange={handleChangeUpdate}
...
export default UpdateOfficeModel;