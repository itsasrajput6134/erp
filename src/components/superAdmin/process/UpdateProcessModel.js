...
const UpdateProcessModel = ({isModalOpenUpdate, handlecloseUpdate, updateProcess, handleChangeUpdate, handlUpdate}) => {
  if(!isModalOpenUpdate) return null
  return (
...
export default UpdateProcessModel;